...
export default function Contact() {
  ...
  return (
    <div className="text-gray-200 py-16 px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-gray-700/50 shadow-lg">
              ...
              <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-4 border border-blue-800/20">
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-sm font-semibold text-blue-300">Currently Available</h3>
                </div>
                <p className="mt-2 text-sm text-gray-300">
                  I'm open to freelance projects, speaking engagements, and full-time opportunities. Feel free to reach out!
                </p>
              </div>
            </div>
          </div>
