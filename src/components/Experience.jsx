...
export default function Experience() {
  ...
  const experiences = [
    {
      ...
      description:
        "My work at Datawave Labs involved building LLM applications and integrating AI based solution using generative AI. Creating an AI agent to monitor databases. Assisting in the creation and enhancement of company product ",
      technologies: [
        "React",
        "SQL",
        "Python",
    ...
    },
    {
      ...
      role: "Co-Founder, Event Management Lead, Web Dev Co-Lead",
      period: "Feb 2024 - March 2025",
      description:
        "Provided my insights on strategic leadership to shape club's vision and fostering innovation, collaborating with other developers, organizing and managing successful tech events, workshops and mentoring members",
      technologies: ["React", "Github", "Docker", "AWS"],
      logo: null, // You can add your own logo here
      color: "purple",
    },
  ];
  ...
  return (
    <div className=" text-gray-200 py-6 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto" id = "experience">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <h3 className="text-gray-300 font-medium mt-1">
                          {exp.role}
                        </h3>
                      </div>
                    </div>
